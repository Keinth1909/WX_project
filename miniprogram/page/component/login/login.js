...
Page({
      ...
      data: {
            ...
            qqnum: '',
            email: '',
            regions: JSON.parse(config.data).regions,
      },
      choose(e) {
            let that = this;
            that.setData({
      ...
      //获取用户手机号
     ipInput(e){
       this.data.ipnum = e.detail.value;
     },
      wxInput(e) {
      ...
      check() {
            ...
            db.collection('user').add({
                  data: {
                        ipnum: that.data.ipnum,
                        regions: that.data.regions[that.data.ids],
